...
const RestaurantDiscovery = () => {
  ...
  const renderRestaurantCard = (restaurant: Restaurant, showBooking: boolean = false) => (
            ...
            {showBooking ? (
              ...
              <>
                <Button 
                  size="sm" 
                  className="flex-1"
                  onClick={() => alert(`Ordering from ${restaurant.name} for delivery`)}
                >
                  Order Now
                </Button>
                <Button 
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {/* Service Tabs */}
        <Tabs defaultValue="delivery" value={selectedTab} onValueChange={setSelectedTab} className="mb-6">
          ...
          <TabsContent value="delivery">
            ...
            <div className="mb-4">
              <p className="text-muted-foreground">
                {filteredRestaurants.length} restaurants available for delivery in {selectedCity}
              </p>
            </div>
          ...
          <TabsContent value="dining">
            ...
            <div className="mb-4">
              <p className="text-muted-foreground">
                {filteredRestaurants.length} restaurants available for dining in {selectedCity}
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredRestaurants.map((restaurant) => renderRestaurantCard(restaurant, true))}
            </div>
          ...
          <TabsContent value="nightlife">
            <div className="text-center py-12">
              <h3 className="text-xl font-semibold mb-4">Nightlife Coming Soon!</h3>
              <p className="text-muted-foreground mb-6">
                We're working on bringing you the best bars, pubs, and nightlife spots in {selectedCity}.
              </p>
